...
// Centered, futuristic "welcome" card for the Deal Maker agent.
// The agent introduces himself professionally, then invites the visitor to chat.
  ...
  return (
    <div className="fixed inset-0 z-[70] flex items-center justify-center p-4">
      ...
      <motion.div
        ...
        className="relative w-full max-w-lg rounded-3xl overflow-hidden border border-white/10 bg-[#0b0b13]/95 shadow-2xl shadow-black/60"
      >
