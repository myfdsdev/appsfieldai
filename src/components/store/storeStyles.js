...
export const STORE_STYLES = [
  ...
  },
  {
    slug: "monolith",
    name: "Binasea",
    tagline: "Dark NFT marketplace — navy surface, indigo accents, pill buttons",
    // Binasea uses Urbanist across headings and body.
    headingFont: "'Urbanist', sans-serif",
    bodyFont: "'Urbanist', sans-serif",
    googleFonts: ["Urbanist:wght@400;500;600;700;800"],
    // Full palette — Binasea's dark navy with electric indigo.
    palette: {
      accent: "#5142fc",
      accentText: "#ffffff",
      surface: "#14141f",
    ...
    hero: {
      size: "lg",
      align: "left",
      titleClass: "text-4xl sm:text-5xl lg:text-6xl font-extrabold leading-[1.1] tracking-tight",
      gradientTitle: false,
    ...
    products: {
      ...
      cardBg: "bg-[#1f1f2b]",
      cardHover: "hover:-translate-y-1 hover:border-[#5142fc]/60 hover:shadow-xl hover:shadow-[#5142fc]/20",
      titleClass: "font-bold text-base tracking-tight",
      uppercaseTitle: false,
    },
    sectionTitleClass: "text-3xl sm:text-4xl font-extrabold tracking-tight",
    preview: { bg: "linear-gradient(135deg,#5142fc,#14141f)", font: "'Urbanist',sans-serif" },
  },
  {
    slug: "neon",
    name: "Neon Grid",
  ...
  },
  {
    slug: "appsfield",
    name: "Appsfield",
    tagline: "Lifetime deals marketplace — light, orange, Outfit headings",
    ...
    products: {
      ...
      cardBg: "bg-white",
      cardHover: "hover:-translate-y-1 hover:border-[#FF6B00] hover:shadow-lg",
